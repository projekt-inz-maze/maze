...
export const POST_SUBMIT_TASK_FILE = `${BASE_URL}/task/submit/add-result`
...
const POINTS_ALL = `${BASE_URL}/points/all` // TODO: Remove this.
...
export const ADD_FILE = `${GET_FILE}/add`
